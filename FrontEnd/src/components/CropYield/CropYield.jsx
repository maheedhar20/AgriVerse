  ...
  return (
    ...
    >
      ...
      <input
        ...
        <label for="season" htmlFor="state" className="block text-gray-700 text-sm font-bold mb-2" >Select an option:</label>
        ...
        <input
            ...
            name="area"
            type="number"
            placeholder="Enter the Area (in hecteres )"
            required
          />
           <label  className="block text-gray-700 text-sm font-bold mb-2" >Rainfall</label>
        <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-0 focus:border-gray-900 placeholder-[#a56d39]"
            id="rainfall"
            name="rainfall"
